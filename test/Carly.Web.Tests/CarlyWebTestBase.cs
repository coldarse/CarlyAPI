...
{
    public abstract class CarlyWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CarlyWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CarlyWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CarlyDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CarlyDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CarlyDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CarlyDbContext, Task<T>> func)
        {
            T result;
