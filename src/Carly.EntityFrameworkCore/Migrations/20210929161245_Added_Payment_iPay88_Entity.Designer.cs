...
namespace Carly.Migrations
{
    ...
    [Migration("20210929161245_Added_Payment_iPay88_Entity")]
    partial class Added_Payment_iPay88_Entity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Carly.AddOns.AddOn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Carly.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Carly.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Carly.Payments.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SingatureType")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("Carly.Sales.Sale", b =>
                {
                    ...
                    b.Property<string>("ClaimedVoucher")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("Carly.Vouchers.GeneratedVoucher", b =>
                {
                    ...
                    b.ToTable("GeneratedVouchers");
                });

            modelBuilder.Entity("Carly.Vouchers.Voucher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Carly.iPay88s.iPay88", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Carly.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Carly.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Carly.AddOns.AddOn", b =>
                {
                    b.HasOne("Carly.Principals.Principal", null)
                        .WithMany("AddOns")
            ...
            modelBuilder.Entity("Carly.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("Carly.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Carly.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
