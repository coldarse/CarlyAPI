    ...
    public class UserAppService : AsyncCrudAppService<User, UserDto, long, PagedUserResultRequestDto, CreateUserDto, UserDto>, IUserAppService
    {
        ...
        public async Task<bool> SendEmail(EmailContentDto emailContentDto)
        {
            ...
            string EmailBody = "<html lang=\"en\">"
                ...
                + "<p style=\"font-family:Quicksand; font-size:16px; text-align:center; line-height:1.5; margin:0;\">Lowest Pricing</p>"
                ...
                + "<div>"
                + "<p style=\"text-align:center; margin: 0 0 25px;\"><a href=\"{ViewQuoteLink}\" style=\"background-color:#000; color:#fff; font-family:Quicksand; font-size:16px; padding:18px 35px; text-decoration:none; border-radius:35px; display:inline-block; line-height:1\" "
